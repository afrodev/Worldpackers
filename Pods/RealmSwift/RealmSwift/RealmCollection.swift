...
public protocol RealmCollectionType: Collection, CustomStringConvertible {
    ...
    /**
     ...
     - parameter ascending: The direction to sort in.
     */
    func sorted(_ byProperty: String, ascending: Bool) -> Results<Element>
...
public final class AnyRealmCollection<T: Object>: RealmCollectionType {
    ...
    */
    ...
    /**
     ...
     - returns: A token which must be held for as long as you want updates to be delivered.
     */
    public func addNotificationBlock(_ block: (RealmCollectionChange<AnyRealmCollection>) -> Void)
        -> NotificationToken { return base._addNotificationBlock(block) }

    /// :nodoc:
    public func _addNotificationBlock(_ block: (RealmCollectionChange<AnyRealmCollection>) -> Void)
        -> NotificationToken { return base._addNotificationBlock(block) }
}
